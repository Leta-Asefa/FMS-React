...
const AddUsers = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch('http://gonderdms.onrender.com/auth/all/users');
        if (!response.ok) {
  ...
  const handleAddUsers = async () => {
    ...
    try {
      ...
      const response = await fetch('http://gonderdms.onrender.com/folders/permission/' + contextRootId, {
        method: 'POST',
        headers: {
